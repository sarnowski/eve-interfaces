...
public interface IndustryJobs<J extends IndustryJobs.Job> extends ApiListResult<J> {
    ...
    interface Job extends ApiResult {
         ...
         * @see {@link IndustryJobs#getContainerTypeId()} to determine if the container is a station.
         */
        long getContainerId();
        ...
        /**
         * @return Completion status - only matters if {@link IndustryJobs#isCompleted()} returns true
         */
